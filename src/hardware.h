...
#define SYS_IOPT_Relays_MUTE			PORTB, 0	// In/Out: not used, or Mute Coil of Bi-Stable Relay if old Audio Section, 
													// Input: Hardware ID: 0=7.0,  1=7.1 (Pullup)
...
struct config_t {	// master configuration variable, set be the Init routines
